    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
        ...
        <div id="hs-navbar-example"
            ...
            <div
                ...
                <a wire:navigate
                    class="font-medium  {{ request()->is('/') ? 'text-blue-500' : 'text-gray-600' }} py-3 md:py-6"
                    href="/" aria-current="page">Home</a>
                <a wire:navigate
                    class="font-medium {{ request()->is('categories') ? 'text-blue-500' : 'text-gray-600' }} py-3 md:py-6 hover:text-gray-400"
                    href="/categories">Categories</a>
                <a wire:navigate
                    class="font-medium {{ request()->is('products') ? 'text-blue-500' : 'text-gray-600' }}  py-3 md:py-6 hover:text-gray-400"
                    href="/products">Products</a>
                <a wire:navigate
                    class="font-medium flex items-center {{ request()->is('cart') ? 'text-blue-500' : 'text-gray-600' }} hover:text-gray-400 py-3 md:py-6"
                    href="/cart">
                ...
                @auth
                    <div
                        ...
                        <button type="button"
                            class="hs-dropdown-toggle flex items-center w-full text-gray-500 hover:text-gray-400 font-medium dark:text-gray-400 dark:hover:text-gray-500">
                            {{ auth()->user()?->name }}
