<header class="relative flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3">
    ...
    <div id="hs-navbar-example" class="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow sm:block" aria-labelledby="hs-navbar-example-collapse">
      <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
        <a class="font-medium  {{ request()->is('/') ? 'text-blue-500' : 'text-gray-600' }} focus:outline-none" href="#" aria-current="page">Home</a>
        <a class="font-medium {{ request()->is('/categories') ? 'text-blue-500' : 'text-gray-600' }} hover:text-gray-400 focus:outline-none focus:text-gray-400" href="#">Categories</a>
        <a class="font-medium {{ request()->is('/products') ? 'text-blue-500' : 'text-gray-600' }} hover:text-gray-400 focus:outline-none focus:text-gray-400" href="#">Products</a>
