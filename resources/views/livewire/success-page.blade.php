<section class="flex items-center font-poppins mt-8">
    <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md md:py-10 md:px-10">
        <div>
            ...
            <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 ">
                ...
                <div class="w-full px-4 mb-4 md:w-1/4">
                    <p class="mb-2 text-sm leading-5 text-gray-600">
                        Payment Method: </p>
                    <p class="text-base font-semibold leading-4 text-gray-800">
                        {{ $order->payment_method == 'cod' ? 'Cash On Delivery' : 'Credit Card' }} </p>
                </div>
            </div>
                ...
                <div
                    ...
                    <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                        ...
                        <div class="flex items-start justify-between w-full">
                            ...
                            <p class="text-lg font-semibold leading-6 text-gray-800">{{ Number::currency(0, 'IDR') }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                ...
                <a href="/my-orders"
                    class="w-full text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-autohover:bg-blue-600 ">
                    View My Orders
                </a>
            </div>
        </div>
